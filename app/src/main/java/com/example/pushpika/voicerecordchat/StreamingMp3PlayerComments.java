...
public class StreamingMp3PlayerComments extends Activity implements View.OnClickListener, View.OnTouchListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener {
        ...
        private void initView() {
            ...
            editTextSongURL.setText(MainActivity.WEB_SERVER+"comments/"+ViewComments.current_comment_audio_id+".mp3");
